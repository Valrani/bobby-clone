...
class SubscriptionLibrary: ObservableObject {
  ...
  @Published var allSubscriptions = [
    Subscription(name: "PlayStation Plus", price: 50, iconString: "plus", colorHex: "#00A1FF", firstBilling: _2020_01_01, billingCycleNumber: 1, billingCycleTimeUnit: .year),
    ...
    Subscription(name: "Netflix", price: 29.99, iconString: "n.circle", colorHex: "#FF3535", billingCycleNumber: 3, billingCycleTimeUnit: .month),
    Subscription(name: "Firebase", price: 25, iconString: "flame.fill", colorHex: "#FFC100", billingCycleNumber: 2, billingCycleTimeUnit: .week)
  ]
